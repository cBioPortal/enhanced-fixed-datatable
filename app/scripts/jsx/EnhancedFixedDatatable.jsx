              ...
              data-qtip={label}>
          {
            (field === 'name' && tableType === 'pieLabel') ? (
              <svg width="15" height="10">
                <g>
                  <rect height="10" width="10" fill={color}></rect>
                </g>
              </svg>
            ) : ''
          }
...
// Wrapper for the header rendering
  ...
  var CustomizeCell = React.createClass({
    ...
    render: function() {
      ...
      return (
        <Cell onFocus={this.onFocus} className={'EFDT-cell EFDT-cell-full' +
        ...
        </span>
          {
            field === 'gene' && data[rowIndex].row.qval ?
              (tableType === 'mutatedGene' ?
                < img src="images/mutsig.png" className="hasQtip qval-icon"
                      data-qtip={'<b>MutSig</b><br/><i>Q-value</i>: ' + data[rowIndex].row.qval}
                      alt="MutSig"/> :
                < img src="images/gistic.png" className="hasQtip qval-icon"
    ...
    render: function() {
      ...
      return (
        <div className="EFDT-table" id={this.props.elementId}>
          <div className="EFDT-table-prefix">
